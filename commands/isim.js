...
run: async(client, msg, args, guild) => {
    if(!message.member.roles.cache.has()) !message.member.hasPermission(8); return message.channel.send("Bu komudu kullanabilmek i̤in yeterli yetkin bulunmuyor.").filter(x => x.delete(500));
